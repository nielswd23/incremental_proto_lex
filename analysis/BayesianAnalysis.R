...
fit_and_predict_bayesian <- function(train_dataset, seed, gram, model){
  ...
  dir.create("./KFoldModelFits_positional_incremental/PUDDLE")
  ...
  b_model <- brm(my_bf,
                 ...
                 thin = 1,
                 seed = seed,
                 save_model = paste0("./KFoldModelFits_positional_incremental/PUDDLE/",gram,"_prob_",model,"_brmsSeed_",seed,".stan"),
                 file = paste0("./KFoldModelFits_positional_incremental/PUDDLE/",gram,"_prob_",model,"_brmsSeed_",seed,"fit"),
...
all_scored_lists <- list.files("../ScoredLists/incremental/PUDDLE", recursive = TRUE, full.names = TRUE)
...
list_of_model_types <- list.dirs("../ScoredLists/incremental/PUDDLE", recursive = FALSE, full.names = FALSE)
...
for (model in list_of_model_types[c(7,8)]) {
  ...
  dir.create("./Results_incremental/PUDDLE")
  write_csv(res, paste0("./Results_incremental/PUDDLE/", model, "_auto_kfold.csv"))
}
