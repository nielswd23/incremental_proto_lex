...
fit_and_predict_bayesian <- function(train_dataset, seed, gram, model){
  ...
  dir.create("./KFoldModelFits_ngram_incremental/JPSD_d_1.55")
  ...
  b_model <- brm(my_bf,
                 ...
                 thin = 1,
                 seed = seed,
                 save_model = paste0("./KFoldModelFits_ngram_incremental/JPSD_d_1.55/",gram,"_prob_",model,"_brmsSeed_",seed,".stan"),
                 file = paste0("./KFoldModelFits_ngram_incremental/JPSD_d_1.55/",gram,"_prob_",model,"_brmsSeed_",seed,"fit"),
...
for (model in list_of_model_types[c(7,8)]) {
  ...
  dir.create("./Results_incremental_ngram/JPSD_d_1.55")
  write_csv(res, paste0("./Results_incremental_ngram/JPSD_d_1.55/", model, "_auto_kfold.csv"))
}
